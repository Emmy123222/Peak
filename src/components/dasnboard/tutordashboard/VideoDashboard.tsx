...
export default function VideoDashboard({
  ...
  const handleNextYear = () => {
    ...
    if (nextYear >= 2001) { // Boundary check (assuming 2001 is the earliest year)
      ...
      // No need to set pastQuestionTitle here; it will be updated via props
    }
  };
  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <h3 className="text-lg font-semibold text-gray-800">{pastQuestionTitle}</h3>
      </div>
      ...
      <div className="flex justify-between gap-2">
        <div className="flex items-center gap-[34px] text-sm text-gray-600">
          <span className="flex items-center gap-1">
            <span className="text-purple-600">⏱</span> 2hr 30mins
          </span>
          <span className="flex items-center gap-1">
            <span className="text-purple-600">📝</span> 90 Solved questions
          </span>
          <button
            onClick={() => setIsModalOpen(true)} // Open modal on click
            className="px-4 py-2 text-sm rounded-full border border-[#640789] text-[#640789]"
          >
            View Analytics 📊
          </button>
        </div>
      ...
      <div className="flex gap-6">
        {/* Left Panel (Video and Related Content) */}
        <div className="w-3/4 space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <h4 className="font-medium">Peter Mathew</h4>
                  <p className="text-sm text-gray-600">Tutor</p>
                </div>
              </div>
              <button className="px-4 py-2 text-sm rounded-full bg-purple-100 text-purple-900 hover:bg-purple-200">
                Message
              </button>
            </div>
          </div>
          ...
          <div className="bg-purple-100 rounded-lg p-6 flex items-center justify-between">
            <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <div
                      className={`w-3 h-3 rounded-full ${
                        currentSection === section.id && section.completed ? 'bg-green-500' : 'bg-gray-400'
                      }`}
                    />
      ...
      <div className="flex justify-end gap-2">
        <button className="px-4 py-2 text-purple-600 bg-purple-50 rounded-full hover:bg-purple-100">
          Message
        </button>
