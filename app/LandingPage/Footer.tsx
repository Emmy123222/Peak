      ...
      <div className="container mx-auto px-4">
          ...
          <div className="w-full md:w-auto mt-8 md:mt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="bg-white/10 border-none rounded-full px-6 py-3 flex-grow text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-white/30"
              />
              <Button
                type="submit"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-8">
          ...
          <div className="flex  space-x-4">
            ...
            <a
              href="#"
              className="bg-purple-800 hover:bg-purple-700 rounded-full w-10 h-10 flex items-center justify-center"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
